            ...
            >
              <div
                ...
                <div class="py-1" role="none">
                  <Link
                    :href="route('offer.all', {sort: 'desc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?sort=desc`}"
                    role="menuitem"
                    tabindex="-1"
                  >
                    Najnowsze Oferty
                  ...
                  <Link
                    :href="route('offer.all', {sort: 'asc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?sort=asc`}"
                    role="menuitem"
                    tabindex="-1"
                  >Najstarsze Oferty
                  </Link>
                  <Link
                    :href="route('offer.all', {marza: 'asc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?marza=asc`}"
                    role="menuitem"
                    tabindex="-1"
                  >Marża: rosnąco
                  </Link>
                  <Link
                    :href="route('offer.all', {marza: 'desc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?marza=desc`}"
                    role="menuitem"
                    tabindex="-1"
                  >Marża: malejąco
                  </Link>
                  <Link
                    :href="route('offer.all', {prowizja: 'asc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?prowizja=asc`}"
                    role="menuitem"
                    tabindex="-1"
                  >Prowizja: rosnąco
                  </Link>
                  <Link
                    :href="route('offer.all', {prowizja: 'desc'})"
                    class="text-gray-700 block px-4 py-2 text-sm"
                    :class="{'bg-gray-100 text-gray-900': $page.url === `/oferta/wszystkie?prowizja=desc`}"
                    role="menuitem"
                    tabindex="-1"
                  >Prowizja: malejąco
                  </Link>
