    ...
    <template v-slot:default>
      <div class="w-full">
          ...
          <div class="w-full px-4">
            <div class="max-w-full overflow-x-auto rounded-lg">
              <table class="table-auto w-full shadow-md">
                ...
                <tbody>
                <tr
                  v-for="(credit, index) in props.overpaymentSimulation.data"
                  :key="credit.id"
                >
                  <td
                  ...
                  <td
                    ...
                    <Link
                      :href="route('profil.overpayment.show', credit.id)"
        ...
        <div class="flex justify-between pt-2">
          <div>
            <Link :href="props.overpaymentSimulation.prev_page_url" class="inline-flex items-center px-4 py-2 mr-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
              <svg aria-hidden="true" class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z" clip-rule="evenodd"></path></svg>
              Poprzednia
            </Link>
          </div>
          <div>
            <Link :href="props.overpaymentSimulation.next_page_url" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
              Następna
