  ...
  <section class="rounded-lg shadow-2xl border border-gray-200 bg-white">
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
      <h2 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">
        <span class="block sm:text-left text-center">Porównywarka kredytów hipotecznych</span>
        <span class="block text-indigo-600 sm:text-left text-center mt-1">Znajdź najlepszy kredyt.</span>
      </h2>
      <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
        <div class="inline-flex rounded-md shadow mx-auto sm:mx-0">
          <Link
