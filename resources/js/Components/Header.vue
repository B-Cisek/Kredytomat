...
const mobileMenuToggleOn = ref(false)
...
const handleToggleMobileMenu = () => {
    mobileMenuToggleOn.value = !mobileMenuToggleOn.value
}
</script>

<template>
    <div class="relative border-gray-200 bg-gray-800">
        <div class="mx-auto px-4 sm:px-6">
            <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
                ...
                <div class="-my-2 -mr-2 md:hidden">
                    <button @click="handleToggleMobileMenu"
                            type="button"
                            class="focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-inset hover:bg-gray-700 inline-flex items-center justify-center p-2 rounded-md text-gray-400 text-white"
                            aria-expanded="false">
                ...
                <nav class="hidden space-x-10 md:flex">
                    <Link href="#" class="text-base font-medium text-white">Home</Link>
                    <Link href="#" class="text-base font-medium text-white">Oferta</Link>

                    <div class="relative">
                        <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
                        <button @click="handleToggleMore" type="button"
                                class="focus:outline-none font-medium
                                group inline-flex items-center text-base text-white"
                                aria-expanded="false">
                            ...
                            -->
                            <svg class="text-white ml-2 h-5 w-5 group-hover:text-indigo-900"
                ...
                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    <Link
                        :href="route('login')"
                          class="whitespace-nowrap text-base font-medium text-white px-4 py-2 hover:bg-gray-700 rounded-lg">Zaloguj się</Link>
                    <Link :href="route('register')"
                       class="ml-2 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent
        ...
        -->
        <div v-show="mobileMenuToggleOn" class="absolute inset-x-0 top-0 origin-top-right transform p-2 transition md:hidden">
                ...
                <div class="space-y-6 py-6 px-5">
                    <div>
                        ...
                        <p class="mt-6 text-center text-base font-medium text-gray-500">
                            Masz już konto?
                            <Link :href="route('login')" class="text-indigo-600 hover:text-indigo-500">Zaloguj się</Link>
                        </p>
                    </div>
                </div>
            </div>
