...
<template>
    <header class="bg-gray-800 px-4 sm:px-6">
        <div class="flex items-center justify-between max-w-7xl md:justify-start md:space-x-10 mx-auto py-6">
            ...
            <nav class="hidden space-x-10 md:flex">
                <Link :href="route('home')"
                      class="font-medium hover:bg-gray-300 hover:text-gray-900 px-2 py-1 rounded-md text-base text-gray-500 text-white">
                    Home
                </Link>
                <Link href="#"
                      class="font-medium hover:bg-gray-300 hover:text-gray-900 px-2 py-1 rounded-md text-base text-gray-500 text-white">
                ...
                <div class="relative">
                    ...
                    <button
                        ...
                        type="button"
                        class="hover:bg-gray-300 hover:text-gray-900 px-2 py-1 text-white group inline-flex items-center rounded-md bg-gray-800 text-base font-medium hover:text-gray-900"
                        aria-expanded="false">
            ...
            <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                <Link :href="route('login')"
                      class="whitespace-nowrap text-base font-semibold text-white hover:text-gray-900 hover:bg-gray-300 px-2 py-2 rounded-md">
                    Zaloguj się
                </Link>
                <Link :href="route('register')"
                      class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent
                          bg-indigo-600 px-4 py-2 text-base font-semibold text-white shadow-sm hover:bg-indigo-700">
                    Zarejestruj się
                </Link>
            </div>
        </div>
